...
public class BookServiceV1 {
	...
	/*
	 * bokList를 매개변수로 받아서 console에 보이기
	 */
	...
	public String searchBookName() {
			...
			System.out.println("==========================");
			System.out.println("도서명(-Q: quit) >> ");
			String strName = scanner.nextLine();
			if (strName.contentEquals("-Q")) return "-Q";
	...
	public boolean searchBookName(String strName) {
		...
		// bookList 에는 입력한 도서명에 해당하는 리스트가 담겨있을 것
